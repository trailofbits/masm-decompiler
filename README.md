...
The following MASM procedure implements a simple repeat loop that
doubles the top-of-stack value four times.

```
// Miden assembly implementation
pub proc a_masm_proc
  repeat.4
    dup.0
    add
  end
...
This is the target pseudocode output generated by the decompiler.

```
// Decompiled pseudocode
proc a_masm_proc(v_0) -> Felt {
  v_1 = 0;
  while (v_1 < 4) {
    v_0 = v_0 + v_0;
    v_1 = v_1 + 1;
